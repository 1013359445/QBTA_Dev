//
//  TABroadcastExtensionLauncher.m
//  TRTC-API-Example-OC
//
...
static TABroadcastExtensionLauncher* launch;

API_AVAILABLE(ios(12.0))
@interface TABroadcastExtensionLauncher()
@property (strong, nonatomic) RPSystemBroadcastPickerView* systemBroacastExtensionPicker;
@end

@implementation TABroadcastExtensionLauncher
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        for (NSString* content in contents) {
            ...
            if ([identifier isEqualToString:@"group.com.gsdata.qingReplay"]) {
...
+ (void)launch {
    [[TABroadcastExtensionLauncher sharedInstance] launch];
}
